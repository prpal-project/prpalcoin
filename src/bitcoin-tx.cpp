...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " prpalcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  prpalcoin-tx [options] <hex-tx> [commands]  Update hex-encoded prpalcoin transaction\n" +
            "or:     prpalcoin-tx [options] -create [commands]   Create hex-encoded prpalcoin transaction\n" +
            "\n";
