...
{
    const char* pszTimestamp = "BBC 25/aug/2021 Afghan ambassador calls for Taliban to be monitored";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1629885784, 2085315704, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4c9a6205636e096a70ed9b63ab492713db0348ef6473ca9f8b354ef8a5b00601"));
        assert(genesis.hashMerkleRoot == uint256S("0x2e3a3a02c92d51bf2a7ad67b54b95c415a3fe7cfc0aa4930455459ce4cf131e8"));
        ...
        //vSeeds.emplace_back("seed-a.prpalcoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.prpalcointools.com");
        //vSeeds.emplace_back("dnsseed.prpalcoinpool.org");
        ...
        checkpointData = {
            {
                {  0, uint256S("0x4c9a6205636e096a70ed9b63ab492713db0348ef6473ca9f8b354ef8a5b00601")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.prpalcointools.com");
        vSeeds.emplace_back("seed-b.prpalcoin.loshan.co.uk");
        ...
        checkpointData = {
            {
                {2056, uint256S("4c9a6205636e096a70ed9b63ab492713db0348ef6473ca9f8b354ef8a5b00601")},
            }
        };
