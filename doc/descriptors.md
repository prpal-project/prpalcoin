# Support for Output Descriptors in Prpalcoin Core

Since Prpalcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `prp1...` for mainnet or `tprp1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Prpalcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Prpalcoin Core wallets, a convenience function `combo` is
