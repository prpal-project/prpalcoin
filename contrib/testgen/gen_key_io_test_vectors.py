...
bech32_templates = [
  ...
  ('prp',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('prp',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('prp',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tprp',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tprp',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tprp',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rprp',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rprp',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rprp', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tprp',  17, 32, False, False, False),
  ('rprp',  3,  1, False, False, False),
  ('prp',   15, 41, False, False, False),
  ('tprp',  0, 16, False, False, False),
  ('rprp',  0, 32, True,  False, False),
  ('prp',   0, 16, True,  False, False),
  ('tprp',  0, 32, False, True,  False),
  ('rprp',  0, 20, False, False, True)
]
