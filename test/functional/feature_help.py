...
"""Verify that starting prpalcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start prpalcoin with -h for help text")
        ...
        self.log.info("Start prpalcoin with -version for version information")
        ...
        self.log.info("Start prpalcoind with -fakearg to make sure it does not start")
